...
öffnet. Damit ist die Betriebsart additiv: bestehende Konfigurationen und Merge-Semantik
bleiben unverändert.
...
## ADR-011: Optionale kanonische Snapshot-Authentifizierung
...
## ADR-012: Explizite Tombstones statt impliziter Löschung
...
## ADR-013: Opt-in-Retention mit explizitem Eigentum
...
## ADR-014: Snapshot-Bereinigung braucht getrennte Auswahl- und Freigabegates
...
## ADR-015: Lebenszyklus-Adapter dürfen einen geprüften Pending-Ausschnitt wählen
